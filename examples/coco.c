...
void train_coco(char *cfgfile, char *weightfile)
{
    ...
    yolo_list *plist = get_paths(train_images);
    //int N = plist->size;
...
void validate_coco(char *cfgfile, char *weightfile)
{
    ...
    char *base = "results/";
    yolo_list *plist = get_paths("data/coco_val_5k.list");
    //yolo_list *plist = get_paths("/home/pjreddie/data/people-art/test.txt");
    //yolo_list *plist = get_paths("/home/pjreddie/data/voc/test/2007_test.txt");
    char **paths = (char **)list_to_array(plist);
