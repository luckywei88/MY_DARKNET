...
void validate_yolo(char *cfg, char *weights)
{
    ...
    //yolo_list *plist = get_paths("data/voc.2007.test");
    yolo_list *plist = get_paths("/home/pjreddie/data/voc/2007_test.txt");
    //yolo_list *plist = get_paths("data/voc.2012.test");
    char **paths = (char **)list_to_array(plist);
